...
const height = base.user`What is ${president}'s height? Respond with only the height. Format: D'D"`;
...
const fakeFruits = fakeFruitDetector.user`Fruits:\n${fruits}`;
